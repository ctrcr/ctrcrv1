...
const ArticleWritingCompetition = () => {
    ...
    const committee = CONTACT_DETAILS.articleCompetitionEdition2Committee;
            ...
            <div className="max-w-6xl mx-auto px-4 py-8 pt-32">
                ...
                <div className="bg-gray-50 p-8 rounded-lg mb-12">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center">
                        ...
                        <a
                            href={GOOGLE_FORM_LINKS.articleCompetitionEdition2}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-blue-600 hover:text-blue-800 underline"
                        >
                            {GOOGLE_FORM_LINKS.articleCompetitionEdition2}
                        </a>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <p> <img src="/linkedin_logo.png" width={22} alt="LinkedIn" className="inline-block mr-2" /> <a href={SOCIAL_LINKS.ctrcrLinkedInProfile} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">CTRCR - MNLU Mumbai</a></p>
                                    <p> <img src="/instagram-logo.png" width={22} alt="Instagram" className="inline-block mr-2" /> <a href={SOCIAL_LINKS.ctrcrInstagram} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">@ctrcr_mnlu</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
