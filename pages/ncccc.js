    ...
    const committee = [
        {
            ...
            image: "https://res.cloudinary.com/daagkkrlr/image/upload/v1729368375/gytlorsgb5fpfheqcw1x.jpg"
        },
        {
            name: "Arjun Kapur",
            role: "Convenor",
            image: "https://res.cloudinary.com/daagkkrlr/image/upload/v1729368456/nyiaikpogbkxsdxlvmt3.jpg"
        },
        {
            name: "Suhasini Thakur",
            role: "Associate Convenor",
            image: "https://res.cloudinary.com/daagkkrlr/image/upload/v1729369576/vondaqbql1vx6n5m3iiu.jpg"
        },
        {
            name: "Ekam Khera",
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 pt-20">
            ...
            <div className="bg-gray-50 p-8 rounded-lg mb-12">
                <h2 className="text-2xl font-semibold mb-6">Competition Format & Schedule</h2>
                <ul className="space-y-4">
                    ...
                    <li className="flex flex-col md:flex-row md:items-center">
                        ...
                        <span>12th – 14th April 2025 (Offline Mode at MNLU Mumbai Campus)</span>
                    </li>
                </ul>
            </div>
            ...
            <div className="mb-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                    {partners.map((partner, index) => (
                        <div key={index} className="flex flex-col shadow-md items-center transition-transform duration-300 hover:scale-105 rounded-lg overflow-hidden">
                            ...
                            <h3 className="text-center font-semibold text-lg">{partner.name}</h3>
            ...
            <div className="mb-12">
                <h2 className="text-3xl font-bold mb-6 text-center">Competition Documents</h2>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
                <h2 className="text-2xl font-semibold mb-4">A Commitment to Excellence</h2>
                <p className="text-lg">
